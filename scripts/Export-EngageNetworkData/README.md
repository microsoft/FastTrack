# Microsoft FastTrack Open Source - Export-EngageNetworkData
...
Once you’ve made and saved those changes, you’re ready to go. To run the script, pass the start date for the export and any of the optional parameters shown above. For example, if I wanted to export all data from the main network, I'd run the script like so:

	.\Export-EngageNetworkData.ps1 -startdate 2023-01-14 -enddate 2023-01-31 -IncludeFiles All
